    ...
    return (
        <div className="slider-container">
            <Slider {...settings}>
                ...
                <div className="lg:col-span-1 md:col-span-2 sm:col-span-2 col-span-2 lg:pt-0 sm:pt-[160px]">
                    <img src={rep} className='max-w-[177px] h-[69px] mb-[40px]' alt="" />
                    ...
                    <div className=' text-black my-[20px] flex justify-end'>
                        <Link to={""} className='bg-[#FFFFFF] py-[14px] px-[40px] rounded-full font-semibold font-poppins'>Work With Us</Link>
                    </div>
                </div>
