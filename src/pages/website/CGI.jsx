      ...
      <Container4>
        <div className=" pt-[100px] sm:pb-[80px] pb-[50px] xl:px-0 lg:px-[30px] md:px-[40px] sm:px-[20px] px-[20px]">
          <div className="">
           ...
           text-[22px] font-poppins lg:mt-[60px] md:mt-[30px] sm:mt-[18px] mt-[16px] mb-[15px] sm:leading-[40px] leading-[27px]' data-aos="slide-left" data-aos-duration="500">Achieve immersive visual experiences with our cutting-edge CGI and 2D/3D animation services. We bring imagination to life, creating stunning visual content that captivates and enthralls.
</h2>
          </div>
        </div>
      </Container4>
      ...
      <div className="py-[80px]">
        <Container4>
          <div className="grid grid-cols-1 xl:px-[0px] lg:px-[10px] md:px-[30px] px-[20px] ">
            <h2 className='lg:text-[46px] text-[35px] font-poppins font-semibold mb-[15px] text-[#000000]'>Our techniques:
            </h2>
          </div>
          ...
          <div className="grid md:grid-cols-2 grid-cols-1 gap-6 lg:px-[0px] md:px-[60px] sm:px-[100px] px-[10px]">
            <div className="col-span-1 lg:pr-[60px] pr-[12px] pt-[48px] pl-[12px]"data-aos="slide-right" data-aos-duration="500">
              <img src={Nimble} alt="" />
              <h3 className='lg:text-[28px] text-[22px] font-poppins mb-[16px] text-[#000000] font-semibold'>Enhanced Visual Storytelling</h3>
              <p className='lg:text-[20px] text-[16px] text-[#596868] font-poppins '>Business10X’s CGI, 2D, and 3D services enable clients to tell their brand story in a more dynamic and engaging way. By creating lifelike visuals, animations, and simulations, the agency helps brands communicate complex ideas, product features, or concepts in a visually compelling manner.</p>
            </div>
            <div className="col-span-1 lg:pl-[60px] pl-[12px] pt-[48px] pr-[12px]"data-aos="slide-left" data-aos-duration="500">
              <img src={notched} alt="" />
              <h3 className='lg:text-[28px] text-[22px] font-poppins mb-[16px] text-[#000000] font-semibold'>Product Visualization: </h3>
              <p className='lg:text-[20px] text-[16px] text-[#596868] font-poppins '>Business10X creates highly detailed and realistic 3D product renders that help clients showcase their products in the best light. This is particularly beneficial for e-commerce, marketing materials, and presentations, where high-quality visuals can significantly influence purchasing decisions.
              </p>
            </div>
          </div>
          ...
          <div className="grid md:grid-cols-2 grid-cols-1 gap-6 lg:px-[0px] md:px-[60px] sm:px-[100px] px-[10px]">
            <div className="col-span-1 lg:pr-[60px] pr-[12px] pt-[48px] pl-[12px]"data-aos="slide-right" data-aos-duration="500">
              <img src={Focus} alt="" />
              <h3 className='lg:text-[28px] text-[22px] font-poppins mb-[16px] text-[#000000] font-semibold'>Advertising and Marketing Campaigns:</h3>
              <p className='lg:text-[20px] text-[16px] text-[#596868] font-poppins '>Business10X creates 2D and 3D animations that make advertising campaigns more engaging and impactful. These animations can be used in commercials, social media, and digital marketing to grab attention, convey messages quickly, and leave a lasting impression on the audience.
              </p>
            </div>
            <div className="col-span-1 lg:pl-[60px] pl-[12px] pt-[48px] pr-[12px]" data-aos="slide-left" data-aos-duration="500">
              <img src={Mirror} alt="" />
          ...
          <div className="md:col-span-3 col-span-1 p-[20px] grdnt ">
            <div className="max-w-[535px] my-auto mx-auto">
              <div className="my-[100px]">
                <h2 className='text-[50px] font-poppins mb-[15px] text-[#FFFFFF] '>Through these comprehensive CGI, 2D, and 3D services,</h2>
                <p className='text-[20px] font-poppins text-[#FFFFFF]'> Business10X empowers clients to create visually compelling, immersive content that captures audience attention, enhances brand perception, and drives business growth.</p>
              </div>
            </div>
          </div>
          <div className="md:col-span-2 col-span-1 p-[20px] backgrou">
            <div className="max-w-[310px] my-auto mx-auto ">
              <div className="my-[160px]">
                <h2 className='text-[50px] font-poppins mb-[15px] leading-[60px] text-[#FFFFFF] '>Enhancing brand storytelling</h2>
              </div>
            </div>
          </div>
        </div>
            ...
            <div className="col-span-1  my-auto">
              <div className='px-[15px]' data-aos="slide-left"data-aos-duration="500">
                ...
                <h3 className=' lg:text-[32px] text-[22px] lg:leading-[60px] leading-[40px] TU text-[#000000] font-poppins'>
                  ...
                  Website and App Development</Link>
                </h3>
                <h3 className=' lg:text-[32px] text-[22px] lg:leading-[60px] leading-[40px] TU text-[#000000] font-poppins'>
