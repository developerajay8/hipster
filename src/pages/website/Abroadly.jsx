        ...
        <div className="xl:mx-[118px] md:mx-[45px] mx-[15px] mb-[48px]">
          <h2>
            <span className='md:text-[30px] sm:text-[24px] text-[16px] font-poppins'>
              <span className='md:text-[30px] sm:text-[24px] text-[16px] text-[#00b0ab] font-poppins font-semibold'> Abroadly</span>
              — Travel
            </span>
        ...
        <Container4>
          <div className="grid md:grid-cols-5 grid-cols-1 xl:px-[0px] px-[20px]">
            ...
            <div className="md:col-span-3 col-span-1  lg:pr-[50px] pr-[20px]">
              ...
              <p className='font-poppins sm:text-[20px] text-[16px] mt-[25px] text-[#606e6e]'>Abroadly was founded during the COVID-19 pandemic to help stranded backpackers, travellers and international students connect with host families for free accommodation. The interactive ‘Home away from Home’  platform  grew from a handful of people to a community of 30,000 that expanded to local hosts offering spare bedrooms, and backyards in exchange for employment like farmwork and au pair jobs.</p>
            </div>
            <div className="md:col-span-2 col-span-1 lg:pt-0 sm:pt-[80px] pt-[45px]">
              <div className="mb-[35px]">
                ...
                <p className='text-[24px] text-[#001817] font-semibold'>Abroadly</p>
              </div>
              <div className="flex mb-[35px]">
                ...
                <div className='ml-[45px]'>
                  ...
                  <p className='text-[24px] font-poppins font-semibold text-[#001817]'>Australia, Canada, New Zealand</p>
                </div>
                <div className=''></div>
              </div>
              <div className='mb-[35px]'>
                ...
                <div className="flex-wrap flex">
                  ...
                  <li className='list-none mb-[20px] px-[9px] w-[114px]'>
                    ...
                    <li className='text-center text-[#001817] font-semibold'>
                      <Link to={''}>
                        Multi-user DCMS using PHP Laravel
                      </Link>
                    </li>
                  </li>
                  <li className='list-none mb-[20px] px-[9px] w-[114px]'>
