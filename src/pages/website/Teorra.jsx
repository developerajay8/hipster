  ...
  return (
    <div>
          ...
          <div className="grid md:grid-cols-5 grid-cols-1 xl:px-0  px-[20px]">
            <div className="md:col-span-3 col-span-1 lg:pr-[50px] pr-[20px]" data-aos="slide-right" data-aos-duration="1000">
              ...
              <p className="font-poppins sm:text-[20px] text-[16px] mt-[25px] text-[#606e6e]">
                TEORRA is an intelligent platform that simplifies the process of acquiring sustainable goods. The platform assists the buyer in locating suitable products, linking buyers with confirmed suppliers, and overseeing your orders – all within a single platform.
              </p>
            </div>
      ...
      <div className=" xl:px-[0px] px-[20px]">
        <Container4>
          <div className="w-full p-[40px] Coconat sm:block hidden rounded-xl bg-[#e6e4b7]">
            <div className="teorra"></div>
          </div>
          <div className="mt-[50px]">
          <h5 className="text-[24px] sm:text-[36px] md:text-[48px] font-poppins cla text-center">
  Sustainability <span className="text-[#00b0ab]">geared buyer-seller marketplace platform</span>
</h5>
      ...
      <div className="videoContainer bg-[#ccefee] sm:py-[100px]">
        <div className="flex justify-center">
          <video autoPlay muted loop className="max-w-[1500px]">
            <source src={"https://hipster-inc.com/wp-content/uploads/2023/04/teorra-video.mp4"} type="video/mp4" />
          </video>
        </div>
      </div>
          ...
          <div className="grid md:grid-cols-2 grid-cols-1 gap-4">
            <div className=" my-auto" data-aos="slide-right" data-aos-duration="2000">
              <h5 className="text-[48px] font-poppins text-[#000000]">
                Dashboard <span className="text-[#00b0ab]"> for suppliers</span>
              </h5>
              <p className="mt-[10px] text-[20px] text-[#606e6e]">
            ...
            <div className=" sm:ml-[70px]" data-aos="slide-left" data-aos-duration="2000">
